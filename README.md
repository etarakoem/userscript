...
- [Computer Networking: A Top-Down Approach 8th Edition - Interactive Problems auto answer display](https://github.com/etarakoem/userscript/blob/main/interactive_answer.js)
- [Computer Networking: A Top-Down Approach 8th Edition - Knowledge Check auto answer display](https://github.com/etarakoem/userscript/blob/main/knowledge_check_answer.js)


## Click copy to copy the file content
<img width="763" alt="Screen Shot 2024-05-25 at 2 54 08 PM" src="https://github.com/etarakoem/userscript/assets/50989367/76ff3307-0ae2-4366-ac67-2fb53d9f3e99">
...
## Then paste the script you copied from my repo there and press `Command + S` (if you're on MacOS) or `Control + S` (if you're on Windows) to save and apply
<img width="841" alt="Screen Shot 2024-05-25 at 2 55 32 PM" src="https://github.com/etarakoem/userscript/assets/50989367/53bb1935-f670-4926-b520-491cbf641530">

Now visit the applied page to check out
